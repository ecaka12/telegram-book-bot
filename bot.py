...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hello! I'm NovelTamizh Bot. I help manage your group!\n\n"
                                    ...
                                    "/scan [limit] - Scan group for existing PDF books")
...
async def scan_books(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"🔎 Scanning last {limit} messages for PDFs...")

    try:
        messages = await context.bot.get_forum_topic_history(
        ...
        await update.message.reply_text("❌ Failed to scan group: " + str(e))
        return
